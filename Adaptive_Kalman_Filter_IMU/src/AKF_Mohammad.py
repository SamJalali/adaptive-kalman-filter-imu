...
#     gamma = 1 / sqrt(i+5)
    Q_hat_plus = C_hat*dot(K_k_a,K_k_a.transpose())
    R_hat_plus =(C_hat - H@P_k_minus_a@ht)
...
savetxt('AKF.csv',XX,delimiter=',')
savetxt('P_AKF.csv',PP,delimiter=',')
savetxt('R_AKF.csv',RR,delimiter=',')
savetxt('Q_AKF.csv',QQ,delimiter=',')
